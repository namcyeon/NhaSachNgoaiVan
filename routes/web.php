...
Route::post('/ajax/add-cat-post', [
  'uses' => 'Admin\AdminAjaxController@saveCategoriesPostDetails',
  'as'   => 'save-categories-post-details'
]);
...
Route::post('/ajax/delete-product', [
  'uses' => 'Admin\AdminAjaxController@selectedProductDeleteById',
  'as'   => 'selected-item-delete'
]);
...
Route::get( '/san-pham/dang-xem/{details_slug}', [
  'uses' => 'Frontend\FrontendManagerController@goToDifferentPages',
  'as'   => 'details-page'
]);
...
Route::post( '/san-pham/dang-xem/{details_slug}', [
  'uses' => 'Frontend\UserCommentsController@saveUserComments',
  'as'   => 'save-user-comments'
]);
