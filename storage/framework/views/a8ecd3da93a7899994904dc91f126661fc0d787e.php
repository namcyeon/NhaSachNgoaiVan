    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow:auto;">
      <div class="canvas-container-main">
        ...
        <div id="swap-popover-content" class="hide">
          ...
          <div data-id="<?php echo e($row->id); ?>" data-design_img_url="<?php echo e($row->design_img_url); ?>" data-design_trans_img_url="<?php echo e($row->design_trans_img_url); ?>" class="design-title-items"><div><img src="<?php echo e($row->design_title_icon); ?>"></div><div class="design-title-label"><?php echo $row->title_label; ?></div></div>
...
<input type="hidden" name="track_is_loaded_first" id="track_is_loaded_first" value="<?php echo e($designer_img_elments[0]->design_img_url); ?>">
<input type="hidden" name="track_is_trans_loaded_first" id="track_is_trans_loaded_first" value="<?php echo e($designer_img_elments[0]->design_trans_img_url); ?>">
