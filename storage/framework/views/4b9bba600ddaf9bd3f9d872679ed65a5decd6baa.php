<?php $__env->startSection('blogs-post-list-content'); ?>
<div class="row">
        ...
        <table id="table_for_manufacturers_list" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php if(count($blogs_list_data)>0): ?>
              <?php $__currentLoopData = $blogs_list_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <tr>
                  <?php if(!empty($row['featured_image'])): ?>
                    <td><img src="<?php echo e($row['featured_image']); ?>" alt="<?php echo e(basename ($row['featured_image'])); ?>"></td>
                  <?php else: ?>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        ...
                        <?php if(in_array('delete_blog', $user_permission_list)): ?>
