            ...
            <?php $__currentLoopData = $dashboard_data['latest_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vals): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
              <li class="item">
                <div class="product-img">
                  <?php if($vals['img_url']): ?>
                    <img src="<?php echo e($vals['img_url']); ?>" alt="">
                  <?php else: ?>
                    <img src="<?php echo e(asset('public/images/no-image.png')); ?>" alt="">
                  <?php endif; ?>
                </div>
                <div class="products-info">
                  <a target="_blank" href="<?php echo e(route('details-page', string_slug_format(get_product_title($vals['id'])))); ?>" class="product-title"><?php echo $vals['title']; ?> <span class="label label-warning pull-right"><?php echo $vals['price']; ?></span></a>
