...
<?php elseif(Request::is('product/details/*') || Request::is('san-pham/dang-xem/*')): ?>
...
<?php elseif(Request::is('blog/*') || Request::is('xem-tin/*')): ?>
