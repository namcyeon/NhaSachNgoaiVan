<?php $__env->startSection('add-testimonial-post-content'); ?>
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.add_new_post_top_title')); ?> &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
       <a class="btn btn-default btn-xs" href="<?php echo e(route('admin.testimonial_post_list_content')); ?>"><?php echo e(trans('admin.posts_list')); ?></a>
        <button class="btn btn-primary btn-block" type="submit"><?php echo e(trans('admin.save')); ?></button>
      </div>
    </div>
  </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body testimonial-content">
          <div class="uploaded-testimonial-image">
            <div class="testimonial-sample-img"><img class="upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
