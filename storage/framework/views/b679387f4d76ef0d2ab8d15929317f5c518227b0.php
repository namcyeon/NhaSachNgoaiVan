  ...
  <div class="modal-dialog add-cat-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p class="no-margin top-title"><b><?php echo trans('admin.create_new_post_category'); ?></b></p>
      </div>
          ...
          <div class="custom-input-group">
            ...
            <div class="custom-input-element">
              ...
              <div class="cat-img-content">
                <div class="cat-sample-img"><img class="img-responsive" src="<?php echo e(asset('public/images/upload.png')); ?>" alt=""></div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default attachtopost create-cat-post"><?php echo trans('admin.create_category'); ?></button>
          ...
          <tbody>
            <?php if(count($cat_list_data)>0): ?>
              ...
              <tr>
                ...
                <td><img src="<?php echo e($row['category_img_url']); ?>" alt="<?php echo e(basename ($row['category_img_url'])); ?>"></td>
                <?php else: ?>
