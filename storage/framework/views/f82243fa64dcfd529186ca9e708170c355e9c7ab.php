            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="input-group">
                  <input type="text" name="term_product" class="search-query form-control" placeholder="<?php echo trans('admin.product_name_to_search'); ?>" value="<?php echo e($search_value); ?>" />
            ...
            <?php if($product_all_data->count() > 0): ?>  
              ...
              <tr>
                <?php if(!empty($row['_product_related_images_url']->product_image)): ?>
                  <td><img src="<?php echo e($row['_product_related_images_url']->product_image); ?>" alt="<?php echo e(basename ($row['_product_related_images_url']->product_image)); ?>"></td>
                <?php else: ?>
