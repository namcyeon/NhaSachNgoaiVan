<header class="main-header">
  <div class="logo">
    <a target="_blank" title="<?php echo e(trans('admin.view_online_store')); ?>" href="<?php echo e(route('root')); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <?php echo trans('admin.view_online_store'); ?></a>
  </div>
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <?php if(!empty($user_data['user_photo_url'])): ?>
              <img src="<?php echo e(asset('public/uploads/'. $user_data['user_photo_url'])); ?>" class="user-image" alt=""/>
            <?php else: ?>
              <img src="<?php echo e(asset('public/images/user-outline.png')); ?>" class="user-image" alt=""/>
            <?php endif; ?>
