            ...
            <tbody>
              ...
              <tr>
                ...
                <?php $__currentLoopData = $compare_product_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  <?php if($label == 'Image'): ?>
                  <td><img src="<?php echo e($products['_product_related_images_url']->product_image); ?>" alt="<?php echo e(basename($products['_product_related_images_url']->product_image)); ?>"></td>
                  <?php endif; ?>
                  ...
                  <?php if($label == 'Price'): ?>
                  <td><?php echo get_currency_symbol_by_code( get_frontend_selected_currency() ).$products['_product_price']; ?></td>
                  <?php endif; ?>
