...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title"><?php echo trans('admin.add_new_product'); ?> &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="<?php echo e(route('admin.product_list')); ?>"><?php echo trans('admin.products_list'); ?></a>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-product-image">
            <div class="product-sample-img"><img class="upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
                          ...
                          <div class="custom-input-group">
                            ...
                            <div class="custom-input-element">
                              ...
                              <div class="variation-img-content">
                                <div class="variation-sample-img"><img class="img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>" alt=""></div>
