              ...
              <?php if($brands_numb == 1): ?>
                ...
                <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 extra-padding">
                  <div class="brands-images">  
                    ...
                    <a href="<?php echo e(route('brands-single-page', $brand['slug'])); ?>"><img  src="<?php echo e(url('/'). $brand['brand_logo_img_url']); ?>" alt="<?php echo e(basename(url('/'). $brand['brand_logo_img_url'])); ?>" /></a>
                    <?php else: ?>
