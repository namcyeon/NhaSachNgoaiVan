...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title"><?php echo trans('admin.update_product'); ?> &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="<?php echo e(route('admin.product_list')); ?>"><?php echo trans('admin.products_list'); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="<?php echo e(route('admin.add_product')); ?>"><?php echo trans('admin.add_new_product'); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" target="_blank" href="<?php echo e(route( 'details-page', $product_post_data['post_slug'])); ?>"><?php echo trans('admin.view'); ?></a>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-product-image">
            ...
            <div class="product-sample-img" style="display:none;"><img class="upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
            <div class="product-uploaded-image" style="display:block;"><img class="img-responsive" src="<?php echo e($product_post_data['_product_related_images_url']->product_image); ?>"><div class="remove-img-link"><button type="button" data-target="product_image" class="btn btn-default attachtopost"><?php echo trans('admin.remove_image'); ?></button></div></div>
            <?php else: ?>
            <div class="product-sample-img" style="display:block;"><img class="upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
        ...
        <div class="box-body">
          <div class="uploaded-product-gallery-image">
            ...
            <div class="product-uploaded-gallery-image" style="display:block;">
              ...
              <div class="gallery-image-single-container"><img class="img-responsive" src="<?php echo e($data->url); ?>"><div data-id="<?php echo e($data->id); ?>" class="remove-gallery-img-link"></div></div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
            </div>
            <div class="product-gallery-sample-img" style="display:none;"><img class="gallery-upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
            <?php else: ?>
            <div class="product-gallery-sample-img"><img class="gallery-upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-banner-image">
            ...
            <div class="banner-uploaded-image" style="display:block;"><img class="img-responsive" src="<?php echo e($product_post_data['_product_related_images_url']->shop_banner_image); ?>"><div class="remove-img-link banner-img-remove"><button type="button" class="btn btn-default attachtopost"><?php echo trans('admin.remove_image'); ?></button></div></div>
            <div class="banner-sample-img" style="display:none;"><img class="banner-upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
            <?php else: ?>
            <div class="banner-sample-img"><img class="banner-upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
                          ...
                          <div class="custom-input-group">
                            ...
                            <div class="custom-input-element">
                              ...
                              <div class="variation-img-content">
                                <div class="variation-sample-img"><img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="variation-sample"></div>
                  ...
                  <?php if(count($variation_data)>0): ?>
                    <table class="table table-bordered table-striped admin-data-table">
                      ...
                      <tr>
                        ...
                        <td><img src="<?php echo e($row['_variation_post_img_url']); ?>" alt="<?php echo e(basename ($row['_variation_post_img_url'])); ?>"></td>
                        <?php else: ?> 
                        <td><img src="<?php echo e(asset('resources/assets/images/no-image.png')); ?>" alt="no_img"></td>
                        <?php endif; ?>
                                ...
                                <div class="form-group">
                                  <div class="col-sm-6">
                                    <div class="design-img-content">
                                      ...
                                      <div class="design-img" style="display:block;"><img class="img-responsive" src="<?php echo e($row->design_img_url); ?>" alt=""></div>
                                      <div class="design-sample-img" style="display:none;"><img class="img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>" alt="no_img"></div>  
                                      <?php else: ?>
                                      <div class="design-img" style="display:none;"><img class="img-responsive" alt=""></div>
                                      <div class="design-sample-img" style="display:block;"><img class="img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>" alt="no_img"></div>  
                                      <?php endif; ?>
                                      <br>
                                  ...
                                  <div class="col-sm-6">
                                    <div class="design-img-content">
                                      ...
                                      <div class="trans-design-img" style="display:block;"><img class="img-responsive" src="<?php echo e($row->design_trans_img_url); ?>" alt=""></div>
                                      <div class="trans-design-sample-img" style="display:none;"><img class="img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>" alt="no_img"></div>  
                                      <?php else: ?>
                                      <div class="trans-design-img" style="display:none;"><img class="img-responsive" alt=""></div>
                                      <div class="trans-design-sample-img" style="display:block;"><img class="img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>" alt="no_img"></div>  
                                      <?php endif; ?>
                                      <br>
                                ...
                                <div class="form-group">
                                  <div class="col-sm-12">
                                    <div class="design-title-img-content">
                                      ...
                                      <div class="design-title-img" style="display:block;"><img class="img-responsive" src="<?php echo e($row->design_title_icon); ?>" alt=""></div>
                                      <div class="design-title-sample-img" style="display:none;"><img class="img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>" alt="no_img"></div>
                                      <?php else: ?>
                                      <div class="design-title-img" style="display:none;"><img class="img-responsive" alt=""></div>
                                      <div class="design-title-sample-img" style="display:block;"><img class="img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>" alt="no_img"></div>
                                      <?php endif; ?>
                                      <br>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="seo-preview-content">
            ...
            <p class="link"><?php echo url('/'); ?>/san-pham/dang-xem/<span><?php echo $product_post_data['post_slug']; ?></span></p>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                 ...
                 <div class="manufacturer-name">
                   ...
                   <?php if($row['brand_logo_img_url']): ?><div><img src="<?php echo e(url('/').$row['brand_logo_img_url']); ?>" class="img-responsive"></div><?php else: ?> <div><img src="<?php echo e(asset('resources/assets/images/no-image.png')); ?>" class="img-responsive"></div> <?php endif; ?><div><?php echo $row['name']; ?></div><div>(<?php echo $row['brand_country_name']; ?>)</div>
                 </div>
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                </div>
              </div>
