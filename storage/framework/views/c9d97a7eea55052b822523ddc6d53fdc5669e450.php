          ...
          <div class="col-sm-8">
            <?php if($settings_data['general_settings']['general_options']['site_logo']): ?>
              <div class="site-logo-container">
                <div class="img-div"><img src="<?php echo e(asset('public/uploads/'.$settings_data['general_settings']['general_options']['site_logo'])); ?>" class="logo-image" alt=""/></div><br>
              ...
              <div class="no-logo-image" style="display:none;">
                <div class="img-div"><img src="<?php echo e(asset('public/images/user-outline.png')); ?>" class="logo-image" alt=""/></div><br>
