  ...
  <div class="container">
    ...
    <div class="row extra-margin-bottom">
      <div class="col-xs-12 col-sm-12 col-md-12">
        <img src="<?php echo e($single_product_details['_product_related_images_url']->shop_banner_image); ?>" alt="" class="img-responsive" />
      </div>
    </div> 
    <?php endif; ?>
        ...
        <div class="product-main-content">
          <div class="product-main-image">
            <?php if( !empty($single_product_details['_product_related_images_url']->product_image) && $single_product_details['_product_related_images_url']->product_image != '/images/upload.png'): ?>
              <img src="<?php echo e($single_product_details['_product_related_images_url']->product_image); ?>" id="product_image_zoom" data-zoom-image="<?php echo e($product_zoom_image); ?>" alt="<?php echo e(basename($single_product_details['_product_related_images_url']->product_image)); ?>" class="img-responsive"/>
            <?php endif; ?>
          ...
          <div id="product_gallery_image" class="product-gallery-image">
            <?php $__currentLoopData = $single_product_details['_product_related_images_url']->product_gallery_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
              ...
              <?php if($count == 1): ?>
              <a  href="#" class="elevatezoom-gallery active" data-image="<?php echo e($row->url); ?>" data-zoom-image="<?php echo e($row->zoom_img_url); ?>"><img src="<?php echo e($row->url); ?>" width="100"  /></a>
              <?php else: ?>
              <a  href="#" class="elevatezoom-gallery" data-image="<?php echo e($row->url); ?>" data-zoom-image="<?php echo e($row->zoom_img_url); ?>"><img src="<?php echo e($row->url); ?>" width="100"  /></a>
              <?php endif; ?>
                            ...
                            <li class="comment">
                              <div class="comment-container clearfix">
                                <div class="user-img">
                                  ...
                                  <img alt="" src="<?php echo e(asset('public/uploads/'. $comment->user_photo_url)); ?>" class="avatar photo" width="60" height="60">
                                  <?php else: ?>
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 extra-padding grid-view">
              <div class="hover-product">
                <div class="hover">
                  ...
                  <img class="img-responsive" src="<?php echo e($products['_product_related_images_url']->product_image); ?>" alt="<?php echo e(basename($products['_product_related_images_url']->product_image)); ?>" />
                  <?php else: ?>
