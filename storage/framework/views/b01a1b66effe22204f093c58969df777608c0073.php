...
<?php echo HTML::style('resources/assets/dist/css/skins/_all-skins.min.css'); ?>

<?php echo HTML::style('resources/assets/plugins/iCheck/square/blue.css'); ?>

<?php echo HTML::style('resources/assets/plugins/datepicker/datepicker3.css'); ?>
...
<?php echo HTML::style('resources/assets/plugins/morris/morris.css'); ?>

<?php echo HTML::style('resources/assets/editor/summernote.css'); ?>
...
<?php echo HTML::script('resources/assets/plugins/datepicker/bootstrap-datepicker.js'); ?>
...
<!--<?php echo HTML::script('resources/assets/plugins/fullcalendar/fullcalendar.min.js'); ?>-->
...
<?php echo HTML::script('resources/assets/plugins/morris/raphael-min.js'); ?>

<?php echo HTML::script('resources/assets/plugins/morris/morris.min.js'); ?>

<?php echo HTML::script('resources/assets/js/admin/shopist.js'); ?>
...
<?php echo HTML::script('resources/assets/dist/js/app.min.js'); ?>

<?php echo HTML::script('resources/assets/editor/summernote.min.js'); ?>
