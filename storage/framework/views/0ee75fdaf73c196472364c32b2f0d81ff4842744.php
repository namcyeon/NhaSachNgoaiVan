<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu">
      ...
      <?php endif; ?>
      		<li class="sidebar-cms-title">Quản lí CMS</li>
            ...
            <ul class="treeview-menu">
              <?php if(in_array('all_testimonial', $user_permission_list)): ?>
                <?php if(Request::is('admin/testimonial/list')): ?>
                  <li class="active"><a href="<?php echo e(route('admin.testimonial_post_list_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.testimonial_list'); ?></a></li>
                <?php else: ?>
                  <li><a href="<?php echo e(route('admin.testimonial_post_list_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.testimonial_list'); ?></a></li>
                <?php endif; ?>
              <?php endif; ?>
              ...
              <?php if(in_array('add_edit_testimonial', $user_permission_list)): ?>
                <?php if(Request::is('admin/testimonial/add') || Request::is('admin/testimonial/update/*')): ?>
                  <li class="active"><a href="<?php echo e(route('admin.testimonial_post_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.add_testimonial_list'); ?></a></li>
                <?php else: ?>
                  <li><a href="<?php echo e(route('admin.testimonial_post_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.add_testimonial_list'); ?></a></li>
                <?php endif; ?>
              <?php endif; ?>
            </ul>
          </li>
      ...
      <?php endif; ?>	  	       <?php if(in_array('manage_brands', $user_permission_list)): ?>        <?php if(Request::is('admin/manufacturers/list') || Request::is('admin/manufacturers/add') || Request::is('admin/manufacturers/update/*')): ?>          <li class="active treeview">            <a href="#">              <i class="fa fa-apple"></i> <span><?php echo trans('admin.manufacturers'); ?></span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <?php if(Request::is('admin/manufacturers/list')): ?>                  <li class="active"><a href="<?php echo e(route('admin.manufacturers_list_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.all_manufacturers'); ?></a></li>              <?php else: ?>                <li><a href="<?php echo e(route('admin.manufacturers_list_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.all_manufacturers'); ?></a></li>              <?php endif; ?>              <?php if(Request::is('admin/manufacturers/add') || Request::is('admin/manufacturers/update/*')): ?>                <li class="active"><a href="<?php echo e(route('admin.add_manufacturers_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.add_manufacturer'); ?></a></li>              <?php else: ?>                 <li><a href="<?php echo e(route('admin.add_manufacturers_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.add_manufacturer'); ?></a></li>              <?php endif; ?>            </ul>          </li>        <?php else: ?>          <li class="treeview">            <a href="#">              <i class="fa fa-apple"></i> <span><?php echo trans('admin.manufacturers'); ?></span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <li><a href="<?php echo e(route('admin.manufacturers_list_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.all_manufacturers'); ?></a></li>              <li><a href="<?php echo e(route('admin.add_manufacturers_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.add_manufacturer'); ?></a></li>            </ul>          </li>        <?php endif; ?>      <?php endif; ?>  	  	       <?php if(in_array('manage_seo', $user_permission_list)): ?>        <?php if(Request::is('admin/manage/seo')): ?>          <li class="active">            <a href="<?php echo e(route('admin.manage_seo_content')); ?>" class="active">              <i class="fa fa-search-plus"></i> <span><?php echo trans('admin.seo_label'); ?></span>            </a>          </li>        <?php else: ?>          <li>            <a href="<?php echo e(route('admin.manage_seo_content')); ?>">              <i class="fa fa-search-plus"></i> <span><?php echo trans('admin.seo_label'); ?></span>            </a>          </li>        <?php endif; ?>      <?php endif; ?>  
        	<li class="sidebar-cms-title">Quản lí cửa hàng</li>	
      <?php if(in_array('manage_products', $user_permission_list)): ?>  
        ...
        <?php endif; ?>
      <?php endif; ?>  	  	        <?php if(in_array('manage_orders', $user_permission_list)): ?>        <?php if(Request::is('admin/orders') || Request::is('admin/orders/details/*') || Request::is('admin/orders/current-date')): ?>          <li class="active">            <a href="<?php echo e(route('admin.shop_orders_list')); ?>">              <i class="fa fa-file-text-o"></i> <span><?php echo trans('admin.orders'); ?></span>            </a>          </li>        <?php else: ?>          <li>            <a href="<?php echo e(route('admin.shop_orders_list')); ?>">              <i class="fa fa-file-text-o"></i> <span><?php echo trans('admin.orders'); ?></span>            </a>          </li>        <?php endif; ?>      <?php endif; ?>                <?php if(in_array('manage_reports', $user_permission_list)): ?>        <?php if(Request::is('admin/reports') || Request::is('admin/reports/sales-by-product-title') || Request::is('admin/reports/sales-by-month') || Request::is('admin/reports/sales-by-last-7-days') || Request::is('admin/reports/sales-by-custom-days') || Request::is('admin/reports/sales-by-payment-method')): ?>          <li class="active">            <a href="<?php echo e(route('admin.reports_list')); ?>">              <i class="fa fa-bar-chart"></i> <span><?php echo trans('admin.reports'); ?></span>            </a>          </li>        <?php else: ?>          <li>            <a href="<?php echo e(route('admin.reports_list')); ?>">              <i class="fa fa-bar-chart"></i> <span><?php echo trans('admin.reports'); ?></span>            </a>          </li>        <?php endif; ?>      <?php endif; ?>  	  	       <?php if(in_array('manage_coupon', $user_permission_list)): ?>        <?php if( Request::is('admin/coupon-manager/coupon/add') || Request::is('admin/coupon-manager/coupon/update/*') || Request::is('admin/coupon-manager/coupon/list') ): ?>          <li class="active">            <a href="<?php echo e(route('admin.coupon_manager_list')); ?>" class="active">              <i class="fa fa-percent"></i> <span><?php echo trans('admin.coupon_manager_label'); ?></span>            </a>          </li>        <?php else: ?>          <li>            <a href="<?php echo e(route('admin.coupon_manager_list')); ?>">              <i class="fa fa-percent"></i> <span><?php echo trans('admin.coupon_manager_label'); ?></span>            </a>          </li>        <?php endif; ?>      <?php endif; ?>
<li class="sidebar-config-title">Quản lí bán hàng</li>
      ...
      <?php if(in_array('manage_payment_method', $user_permission_list)): ?>
        ...
        <?php endif; ?>
      <?php endif; ?>	  	        <?php if(in_array('manage_requested_product', $user_permission_list)): ?>        <?php if(Request::is('admin/customer/request-product')): ?>          <li class="active">            <a href="<?php echo e(route('admin.request_product_content')); ?>" class="active">              <i class="fa fa-question-circle-o"></i> <span><?php echo trans('admin.request_product_label'); ?></span>            </a>          </li>        <?php else: ?>          <li>            <a href="<?php echo e(route('admin.request_product_content')); ?>">              <i class="fa fa-question-circle-o"></i> <span><?php echo trans('admin.request_product_label'); ?></span>            </a>          </li>        <?php endif; ?>      <?php endif; ?>               <?php if(in_array('manage_subscription', $user_permission_list)): ?>        <?php if(Request::is('admin/subscription/custom') || Request::is('admin/subscription/mailchimp') || Request::is('admin/subscription/settings') ): ?>          <li class="active treeview">            <a href="#">              <i class="fa fa-file-text"></i> <span><?php echo trans('admin.subscriptions_manager_menu_title'); ?></span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <?php if(Request::is('admin/subscription/custom')): ?>                <li class="active"><a href="<?php echo e(route('admin.custom_subscription_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.custom_subscriptions_menu_label'); ?></a></li>              <?php else: ?>                <li><a href="<?php echo e(route('admin.custom_subscription_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.custom_subscriptions_menu_label'); ?></a></li>              <?php endif; ?>              <?php if(Request::is('admin/subscription/mailchimp')): ?>                <li class="active"><a href="<?php echo e(route('admin.mailchimp_subscription_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.mailchimp_subscriptions_label'); ?></a></li>              <?php else: ?>                <li><a href="<?php echo e(route('admin.mailchimp_subscription_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.mailchimp_subscriptions_label'); ?></a></li>              <?php endif; ?>                            <?php if(Request::is('admin/subscription/settings')): ?>                <li class="active"><a href="<?php echo e(route('admin.settings_subscription_content')); ?>"><i class="fa fa-cog"></i> <?php echo trans('admin.subscription_settings_label'); ?></a></li>              <?php else: ?>                <li><a href="<?php echo e(route('admin.settings_subscription_content')); ?>"><i class="fa fa-cog"></i> <?php echo trans('admin.subscription_settings_label'); ?></a></li>              <?php endif; ?>            </ul>          </li>        <?php else: ?>          <li class="treeview">            <a href="#">              <i class="fa fa-file-text"></i> <span><?php echo trans('admin.subscriptions_manager_menu_title'); ?></span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <li><a href="<?php echo e(route('admin.custom_subscription_content')); ?>"><i class="fa fa-table"></i> <?php echo trans('admin.custom_subscriptions_menu_label'); ?></a></li>              <li><a href="<?php echo e(route('admin.mailchimp_subscription_content')); ?>"><i class="fa fa-plus-square-o"></i> <?php echo trans('admin.mailchimp_subscriptions_label'); ?></a></li>              <li><a href="<?php echo e(route('admin.settings_subscription_content')); ?>"><i class="fa fa-cog"></i> <?php echo trans('admin.subscription_settings_label'); ?></a></li>            </ul>          </li>        <?php endif; ?>      <?php endif; ?>  
      
	  <li class="sidebar-extra-features-title">Cài đặt khác</li>
      ...
      <?php if(in_array('manage_settings', $user_permission_list)): ?>        <?php if(Request::is('admin/settings/general') || Request::is('admin/settings/languages') || Request::is('admin/settings/languages/update/*') || Request::is('admin/settings/appearance')): ?>          <li class="active treeview">            <a href="#">              <i class="fa fa-cog"></i> <span><?php echo trans('admin.settings'); ?></span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <?php if(Request::is('admin/settings/general')): ?>                  <li class="active"><a href="<?php echo e(route('admin.general_settings_content')); ?>"><i class="fa fa-circle-o"></i> <?php echo trans('admin.general'); ?></a></li>              <?php else: ?>                 <li><a href="<?php echo e(route('admin.general_settings_content')); ?>"><i class="fa fa-circle-o"></i> <?php echo trans('admin.general'); ?></a></li>              <?php endif; ?>              <?php if(Request::is('admin/settings/languages') || Request::is('admin/settings/languages/update/*')): ?>                <li class="active"><a href="<?php echo e(route('admin.languages_settings_content')); ?>"><i class="fa fa-flag"></i> <?php echo trans('admin.languages'); ?></a></li>              <?php else: ?>                <li><a href="<?php echo e(route('admin.languages_settings_content')); ?>"><i class="fa fa-flag"></i> <?php echo trans('admin.languages'); ?></a></li>              <?php endif; ?>              <?php if(Request::is('admin/settings/appearance')): ?>                <li class="active"><a href="<?php echo e(route('admin.frontend_layout_settings_content')); ?>"><i class="fa fa-paint-brush"></i> <?php echo trans('admin.frontend_layout'); ?></a></li>              <?php else: ?>                <li><a href="<?php echo e(route('admin.frontend_layout_settings_content')); ?>"><i class="fa fa-paint-brush"></i> <?php echo trans('admin.frontend_layout'); ?></a></li>              <?php endif; ?>            </ul>          </li>        <?php else: ?>          <li class="treeview">            <a href="#">              <i class="fa fa-cog"></i> <span><?php echo trans('admin.settings'); ?></span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <li><a href="<?php echo e(route('admin.general_settings_content')); ?>"><i class="fa fa-circle-o"></i> <?php echo trans('admin.general'); ?></a></li>              <li><a href="<?php echo e(route('admin.languages_settings_content')); ?>"><i class="fa fa-flag-o"></i> <?php echo trans('admin.languages'); ?></a></li>              <li><a href="<?php echo e(route('admin.frontend_layout_settings_content')); ?>"><i class="fa fa-paint-brush"></i> <?php echo trans('admin.frontend_layout'); ?></a></li>            </ul>          </li>        <?php endif; ?>      <?php endif; ?>  
