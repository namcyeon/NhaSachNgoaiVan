  ...
  <div class="container">
    ...
    <div class="row extra-margin-bottom">
      <div class="col-xs-12 col-sm-12 col-md-12">
        <img src="{{ $single_product_details['_product_related_images_url']->shop_banner_image }}" alt="" class="img-responsive" />
      </div>
    </div> 
    @endif
    ...
    <div class="row">
        ...
        <div class="product-main-content">
          <div class="product-main-image">
            @if( !empty($single_product_details['_product_related_images_url']->product_image) && $single_product_details['_product_related_images_url']->product_image != '/images/upload.png')
              <img src="{{ $single_product_details['_product_related_images_url']->product_image }}" id="product_image_zoom" data-zoom-image="{{ $product_zoom_image }}" alt="{{ basename($single_product_details['_product_related_images_url']->product_image) }}" class="img-responsive"/>
            @endif
          ...
          <div id="product_gallery_image" class="product-gallery-image">
            @foreach($single_product_details['_product_related_images_url']->product_gallery_images as $key => $row)
              ...
              @if($count == 1)
              <a  href="#" class="elevatezoom-gallery active" data-image="{{ $row->url }}" data-zoom-image="{{ $row->zoom_img_url }}"><img src="{{ $row->url }}" width="100"  /></a>
              @else
              <a  href="#" class="elevatezoom-gallery" data-image="{{ $row->url }}" data-zoom-image="{{ $row->zoom_img_url }}"><img src="{{ $row->url }}" width="100"  /></a>
              @endif
      ...
      <div class="col-xs-12 col-sm-7 col-md-7">
        ...
        @if(( get_product_type($single_product_details['id']) == 'simple_product' || ( get_product_type($single_product_details['id']) == 'downloadable_product' && count(get_product_variations($single_product_details['id'])) == 0 )) && ($single_product_details['_product_manage_stock_availability'] == 'in_stock' || ($single_product_details['_product_manage_stock'] == 'yes' && $single_product_details['_product_manage_stock_back_to_order'] == 'only_allow' && $single_product_details['_product_manage_stock_availability'] == 'in_stock') || ($single_product_details['_product_manage_stock'] == 'yes' && $single_product_details['_product_manage_stock_back_to_order'] == 'allow_notify_customer' && $single_product_details['_product_manage_stock_availability'] == 'in_stock')))
    ...
    <div class="row">
        <div id="product_description_bottom_tab" class="product-description-bottom-tab">
          <ul class="nav nav-tabs">
            @if(!old('comments_target'))
            <li class="active"><a href="#features" data-toggle="tab">{{ trans('frontend.features_label') }}</a></li>
            @else
            <li><a href="#features" data-toggle="tab">{{ trans('frontend.features_label') }}</a></li>
            @endif
            ...
            @if($single_product_details['_product_enable_reviews'] == 'yes')
              @if(old('comments_target'))
              <li class="active"><a href="#reviews" data-toggle="tab">{{ trans('frontend.reviews_label') }} (5)</a></li>
              @else
              <li><a href="#reviews" data-toggle="tab">{{ trans('frontend.reviews_label') }} ({!! $comments_rating_details['total'] !!})</a></li>
              @endif
            @endif
          </ul>
            ...
            @if($single_product_details['_product_enable_reviews'] == 'yes')
              ...
              <div class="product-reviews-content">
                  ...
                  <div class="user-reviews-content">
                        <h2 class="user-reviews-title">{{ $comments_rating_details['total'] }} {{ trans('frontend.reviews_for_label') }} <span>{{ $single_product_details['post_title'] }}</span></h2>
                            ...
                            <li class="comment">
                              <div class="comment-container clearfix">
                                <div class="user-img">
                                  ...
                                  <img alt="" src="{{ asset('public/uploads/'. $comment->user_photo_url) }}" class="avatar photo" width="60" height="60">
                                  @else
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 extra-padding grid-view">
              <div class="hover-product">
                <div class="hover">
                  ...
                  <img class="img-responsive" src="{{ $products['_product_related_images_url']->product_image }}" alt="{{ basename($products['_product_related_images_url']->product_image) }}" />
                  @else
