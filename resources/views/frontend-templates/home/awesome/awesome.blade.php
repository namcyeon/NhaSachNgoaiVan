            ...
            @if($brands_numb == 1)
              ...
              <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 extra-padding">
                <div class="brands-images">  
                  ...
                  <a href="{{ route('brands-single-page', $brand['slug']) }}"><img  src="{{ url('/'). $brand['brand_logo_img_url'] }}" alt="{{ basename(url('/'). $brand['brand_logo_img_url']) }}" /></a>
                  @else
    ...
    <div class="extra-message-tab">
      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <ul class="nav nav-tabs tabs-left">
          ...
          <li><a href="#winter_collection" data-toggle="tab">Winter Collection 2017</a></li>
          <li><a href="#summer_collection" data-toggle="tab">Summer Collection 2017</a></li>
          <li><a href="#newslatter" data-toggle="tab">Newslatter</a></li>
        </ul>
      </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content">
          ...
          <div class="tab-pane" id="winter_collection">
            <div class="row">
              ...
              <div class="col-sm-4">
                <img src="{{ asset('resources/assets/images/add-sample/winter.jpg') }}" class="img-responsive" alt="">
              </div>
            </div>
          </div>
        <div class="tab-pane" id="summer_collection">
          <div class="row">
            <div class="col-sm-8">
              <h3>Summer Collection 2017</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            </div>
            <div class="col-sm-4">
               <img src="{{ asset('resources/assets/images/add-sample/summer.jpg') }}" class="img-responsive" alt="">
            </div>
          </div>  
        </div>
