<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu">
            ...
            <ul class="treeview-menu">
              @if(in_array('all_testimonial', $user_permission_list))
                @if(Request::is('admin/testimonial/list'))
                  <li class="active"><a href="{{ route('admin.testimonial_post_list_content') }}"><i class="fa fa-table"></i> {!! trans('admin.testimonial_list') !!}</a></li>
                @else
                  <li><a href="{{ route('admin.testimonial_post_list_content') }}"><i class="fa fa-table"></i> {!! trans('admin.testimonial_list') !!}</a></li>
                @endif
              @endif
              ...
              @if(in_array('add_edit_testimonial', $user_permission_list))
                @if(Request::is('admin/testimonial/add') || Request::is('admin/testimonial/update/*'))
                  <li class="active"><a href="{{route('admin.testimonial_post_content')}}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.add_testimonial_list') !!}</a></li>
                @else
                  <li><a href="{{route('admin.testimonial_post_content')}}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.add_testimonial_list') !!}</a></li>
                @endif
              @endif
            </ul>
          </li>
      ...
      @endif	  	       @if(in_array('manage_brands', $user_permission_list))        @if(Request::is('admin/manufacturers/list') || Request::is('admin/manufacturers/add') || Request::is('admin/manufacturers/update/*'))          <li class="active treeview">            <a href="#">              <i class="fa fa-apple"></i> <span>{!! trans('admin.manufacturers') !!}</span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              @if(Request::is('admin/manufacturers/list'))                  <li class="active"><a href="{{ route('admin.manufacturers_list_content') }}"><i class="fa fa-table"></i> {!! trans('admin.all_manufacturers') !!}</a></li>              @else                <li><a href="{{ route('admin.manufacturers_list_content') }}"><i class="fa fa-table"></i> {!! trans('admin.all_manufacturers') !!}</a></li>              @endif              @if(Request::is('admin/manufacturers/add') || Request::is('admin/manufacturers/update/*'))                <li class="active"><a href="{{ route('admin.add_manufacturers_content') }}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.add_manufacturer') !!}</a></li>              @else                 <li><a href="{{ route('admin.add_manufacturers_content') }}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.add_manufacturer') !!}</a></li>              @endif            </ul>          </li>        @else          <li class="treeview">            <a href="#">              <i class="fa fa-apple"></i> <span>{!! trans('admin.manufacturers') !!}</span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <li><a href="{{ route('admin.manufacturers_list_content') }}"><i class="fa fa-table"></i> {!! trans('admin.all_manufacturers') !!}</a></li>              <li><a href="{{ route('admin.add_manufacturers_content') }}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.add_manufacturer') !!}</a></li>            </ul>          </li>        @endif      @endif  	  	       @if(in_array('manage_seo', $user_permission_list))        @if(Request::is('admin/manage/seo'))          <li class="active">            <a href="{{ route('admin.manage_seo_content') }}" class="active">              <i class="fa fa-search-plus"></i> <span>{!! trans('admin.seo_label') !!}</span>            </a>          </li>        @else          <li>            <a href="{{ route('admin.manage_seo_content') }}">              <i class="fa fa-search-plus"></i> <span>{!! trans('admin.seo_label') !!}</span>            </a>          </li>        @endif      @endif  
      ...
      @if(in_array('manage_products', $user_permission_list))  
        ...
        @endif
      @endif  	  	        @if(in_array('manage_orders', $user_permission_list))        @if(Request::is('admin/orders') || Request::is('admin/orders/details/*') || Request::is('admin/orders/current-date'))          <li class="active">            <a href="{{ route('admin.shop_orders_list') }}">              <i class="fa fa-file-text-o"></i> <span>{!! trans('admin.orders') !!}</span>            </a>          </li>        @else          <li>            <a href="{{ route('admin.shop_orders_list') }}">              <i class="fa fa-file-text-o"></i> <span>{!! trans('admin.orders') !!}</span>            </a>          </li>        @endif      @endif                @if(in_array('manage_reports', $user_permission_list))        @if(Request::is('admin/reports') || Request::is('admin/reports/sales-by-product-title') || Request::is('admin/reports/sales-by-month') || Request::is('admin/reports/sales-by-last-7-days') || Request::is('admin/reports/sales-by-custom-days') || Request::is('admin/reports/sales-by-payment-method'))          <li class="active">            <a href="{{ route('admin.reports_list') }}">              <i class="fa fa-bar-chart"></i> <span>{!! trans('admin.reports') !!}</span>            </a>          </li>        @else          <li>            <a href="{{ route('admin.reports_list') }}">              <i class="fa fa-bar-chart"></i> <span>{!! trans('admin.reports') !!}</span>            </a>          </li>        @endif      @endif  	  	       @if(in_array('manage_coupon', $user_permission_list))        @if( Request::is('admin/coupon-manager/coupon/add') || Request::is('admin/coupon-manager/coupon/update/*') || Request::is('admin/coupon-manager/coupon/list') )          <li class="active">            <a href="{{ route('admin.coupon_manager_list') }}" class="active">              <i class="fa fa-percent"></i> <span>{!! trans('admin.coupon_manager_label') !!}</span>            </a>          </li>        @else          <li>            <a href="{{ route('admin.coupon_manager_list') }}">              <i class="fa fa-percent"></i> <span>{!! trans('admin.coupon_manager_label') !!}</span>            </a>          </li>        @endif      @endif
<li class="sidebar-config-title">Quản lí bán hàng</li>
      ...
      @if(in_array('manage_payment_method', $user_permission_list))
        ...
        @endif
      @endif	  	        @if(in_array('manage_requested_product', $user_permission_list))        @if(Request::is('admin/customer/request-product'))          <li class="active">            <a href="{{ route('admin.request_product_content') }}" class="active">              <i class="fa fa-question-circle-o"></i> <span>{!! trans('admin.request_product_label') !!}</span>            </a>          </li>        @else          <li>            <a href="{{ route('admin.request_product_content') }}">              <i class="fa fa-question-circle-o"></i> <span>{!! trans('admin.request_product_label') !!}</span>            </a>          </li>        @endif      @endif               @if(in_array('manage_subscription', $user_permission_list))        @if(Request::is('admin/subscription/custom') || Request::is('admin/subscription/mailchimp') || Request::is('admin/subscription/settings') )          <li class="active treeview">            <a href="#">              <i class="fa fa-file-text"></i> <span>{!! trans('admin.subscriptions_manager_menu_title') !!}</span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              @if(Request::is('admin/subscription/custom'))                <li class="active"><a href="{{ route('admin.custom_subscription_content') }}"><i class="fa fa-table"></i> {!! trans('admin.custom_subscriptions_menu_label') !!}</a></li>              @else                <li><a href="{{ route('admin.custom_subscription_content') }}"><i class="fa fa-table"></i> {!! trans('admin.custom_subscriptions_menu_label') !!}</a></li>              @endif              @if(Request::is('admin/subscription/mailchimp'))                <li class="active"><a href="{{route('admin.mailchimp_subscription_content')}}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.mailchimp_subscriptions_label') !!}</a></li>              @else                <li><a href="{{route('admin.mailchimp_subscription_content')}}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.mailchimp_subscriptions_label') !!}</a></li>              @endif                            @if(Request::is('admin/subscription/settings'))                <li class="active"><a href="{{route('admin.settings_subscription_content')}}"><i class="fa fa-cog"></i> {!! trans('admin.subscription_settings_label') !!}</a></li>              @else                <li><a href="{{route('admin.settings_subscription_content')}}"><i class="fa fa-cog"></i> {!! trans('admin.subscription_settings_label') !!}</a></li>              @endif            </ul>          </li>        @else          <li class="treeview">            <a href="#">              <i class="fa fa-file-text"></i> <span>{!! trans('admin.subscriptions_manager_menu_title') !!}</span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <li><a href="{{ route('admin.custom_subscription_content') }}"><i class="fa fa-table"></i> {!! trans('admin.custom_subscriptions_menu_label') !!}</a></li>              <li><a href="{{ route('admin.mailchimp_subscription_content') }}"><i class="fa fa-plus-square-o"></i> {!! trans('admin.mailchimp_subscriptions_label') !!}</a></li>              <li><a href="{{ route('admin.settings_subscription_content') }}"><i class="fa fa-cog"></i> {!! trans('admin.subscription_settings_label') !!}</a></li>            </ul>          </li>        @endif      @endif  
      ...
      @if(in_array('manage_settings', $user_permission_list))        @if(Request::is('admin/settings/general') || Request::is('admin/settings/languages') || Request::is('admin/settings/languages/update/*') || Request::is('admin/settings/appearance'))          <li class="active treeview">            <a href="#">              <i class="fa fa-cog"></i> <span>{!! trans('admin.settings') !!}</span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              @if(Request::is('admin/settings/general'))                  <li class="active"><a href="{{ route('admin.general_settings_content') }}"><i class="fa fa-circle-o"></i> {!! trans('admin.general') !!}</a></li>              @else                 <li><a href="{{ route('admin.general_settings_content') }}"><i class="fa fa-circle-o"></i> {!! trans('admin.general') !!}</a></li>              @endif              @if(Request::is('admin/settings/languages') || Request::is('admin/settings/languages/update/*'))                <li class="active"><a href="{{ route('admin.languages_settings_content') }}"><i class="fa fa-flag"></i> {!! trans('admin.languages') !!}</a></li>              @else                <li><a href="{{ route('admin.languages_settings_content') }}"><i class="fa fa-flag"></i> {!! trans('admin.languages') !!}</a></li>              @endif              @if(Request::is('admin/settings/appearance'))                <li class="active"><a href="{{ route('admin.frontend_layout_settings_content') }}"><i class="fa fa-paint-brush"></i> {!! trans('admin.frontend_layout') !!}</a></li>              @else                <li><a href="{{ route('admin.frontend_layout_settings_content') }}"><i class="fa fa-paint-brush"></i> {!! trans('admin.frontend_layout') !!}</a></li>              @endif            </ul>          </li>        @else          <li class="treeview">            <a href="#">              <i class="fa fa-cog"></i> <span>{!! trans('admin.settings') !!}</span> <i class="fa fa-angle-left pull-right"></i>            </a>            <ul class="treeview-menu">              <li><a href="{{ route('admin.general_settings_content') }}"><i class="fa fa-circle-o"></i> {!! trans('admin.general') !!}</a></li>              <li><a href="{{ route('admin.languages_settings_content') }}"><i class="fa fa-flag-o"></i> {!! trans('admin.languages') !!}</a></li>              <li><a href="{{ route('admin.frontend_layout_settings_content') }}"><i class="fa fa-paint-brush"></i> {!! trans('admin.frontend_layout') !!}</a></li>            </ul>          </li>        @endif      @endif  
