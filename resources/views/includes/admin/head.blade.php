...
{!! HTML::style('resources/assets/dist/css/skins/_all-skins.min.css') !!}
{!! HTML::style('resources/assets/plugins/iCheck/square/blue.css') !!}
{!! HTML::style('resources/assets/plugins/datepicker/datepicker3.css') !!}
...
{!! HTML::style('resources/assets/plugins/morris/morris.css') !!}
{!! HTML::style('resources/assets/editor/summernote.css') !!}
...
{!! HTML::script('resources/assets/plugins/datepicker/bootstrap-datepicker.js') !!}
...
<!--{!! HTML::script('resources/assets/plugins/fullcalendar/fullcalendar.min.js') !!}-->
...
{!! HTML::script('resources/assets/plugins/morris/raphael-min.js') !!}
{!! HTML::script('resources/assets/plugins/morris/morris.min.js') !!}
{!! HTML::script('resources/assets/js/admin/shopist.js') !!}
{!! HTML::script('resources/assets/designer/designer.js') !!}
{!! HTML::script('resources/assets/designer/designerControl.js') !!}
{!! HTML::script('resources/assets/dist/js/app.min.js') !!}
