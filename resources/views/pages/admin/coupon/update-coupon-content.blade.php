@section('update-coupon-manager-content')
    ...
    <div class="col-md-12">
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">{{ trans('admin.update_coupon_label') }} &nbsp;&nbsp;&nbsp;&nbsp;</h3>
          <div class="box-tools pull-right">
            <a class="btn btn-default btn-xs" href="{{ route('admin.coupon_manager_list') }}">{{ trans('admin.coupon_list_label') }}</a>
    ...
    <div class="col-md-5">
      <div class="box box-solid">
        ...
        {{--  <div class="form-group" style="display: none;">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label" for="inputUsageEndDate">{{ trans('admin.usage_range_end_date') }}</label>
            <div class="col-sm-9">                  
              <div class="input-group">
                <div class="input-group-addon">
                  <i class="fa fa-calendar"></i>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="form-group">
            <label class="col-sm-3 control-label" for="inputVisibility">{{ trans('admin.enable_coupon') }}</label>
            <div class="col-sm-9">
