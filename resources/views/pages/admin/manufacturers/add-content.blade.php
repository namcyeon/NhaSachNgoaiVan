@section('manufacturers-add-content')
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">{{ trans('admin.add_new_manufacturers') }} &nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.manufacturers_list_content') }}">{{ trans('admin.manufacturers_list') }}</a>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <div class="manufacturers-img-content">
              <div class="manufacturers-sample-img"><img class="img-responsive" src="{{ asset('public/images/upload.png') }}" alt=""></div>
