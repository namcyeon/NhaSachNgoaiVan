@section('manufacturers-update-content')
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">{{ trans('admin.update_manufacturers') }} &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.manufacturers_list_content') }}">{{ trans('admin.manufacturers_list') }}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.add_manufacturers_content') }}">{{ trans('admin.add_more_manufacturers') }}</a>
    ...
    <div class="col-md-12">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="{{ trans('admin.country_name') }}" id="inputCountryName" name="inputCountryName" class="form-control" value="{{ $manufacturers_update_data->country_name }}">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <textarea id="inputShortDescription" name="inputShortDescription" class="dynamic-editor" placeholder="{{ trans('admin.short_description') }}">
             {!! string_decode( $manufacturers_update_data->short_description ) !!}
            </textarea>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <div class="manufacturers-img-content">
              <div class="manufacturers-sample-img" {!! $manufacturers_logo_control['sample_img'] !!}><img class="img-responsive" src="{{ asset('public/images/upload.png') }}" alt=""></div>
              <div class="manufacturers-img" {!! $manufacturers_logo_control['manufacturers_logo'] !!}><img class="img-responsive" src="{{ asset($manufacturers_update_data->logo_url) }}" alt=""></div>
              <br>
...
<input type="hidden" name="logo_img" id="logo_img" value="{{ $manufacturers_update_data->logo_url }}">
</form>
