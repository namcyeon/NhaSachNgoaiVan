...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">{{ trans('admin.update_art') }} &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.clipart_list_content') }}">{{ trans('admin.art_lists') }}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.add_new_art_content') }}">{{ trans('admin.add_more_art') }}</a>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <div class="uploaded-all-art-images">
                ...
                <div class="art-image-single-container"><img class="img-responsive" src="{{ $art_update_data_by_id['art_img_url'] }}"><div data-id="{{ $art_update_data_by_id['id'] }}" class="remove-art-img-link"></div></div>
                @endif
              </div>
            </div>
          </div>
