@section('update-testimonial-post-content')
  ...
  <div class="box">
    <div class="box-header">
      ...
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.testimonial_post_list_content') }}">{{ trans('admin.posts_list') }}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.testimonial_post_content') }}">{{ trans('admin.add_new_post_top_title') }}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" target="_blank" href="{{ route('testimonial-single-page', $testimonial_update_data['post_slug']) }}">{{ trans('admin.view') }}</a>
        <button class="btn btn-primary btn-block" type="submit">{{ trans('admin.update') }}</button>
      </div>
    </div>
  </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body testimonial-content">
          <div class="uploaded-testimonial-image">
            ...
            <div class="testimonial-sample-img" style="display: none;"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
            <div class="testimonial-uploaded-image" style="display:block;"><img class="img-responsive" src="{{ $testimonial_update_data['testimonial_image_url'] }}"><div class="remove-img-link"><button type="button" data-target="testimonial_image" class="btn btn-default attachtopost">{{ trans('admin.remove_image') }}</button></div></div>
            @else
              <div class="testimonial-sample-img" style="display:block;"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
