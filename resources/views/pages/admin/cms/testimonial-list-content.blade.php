@section('testimonial-post-list-content')
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="pull-right">
      <a href="{{ route('admin.testimonial_post_content') }}" class="btn btn-primary pull-right">{{ trans('admin.add_new_post') }}</a>
    </div>  
  </div>
</div>
            ...
            @if(count($testimonial_list_data)>0)
              @foreach($testimonial_list_data as $row)
                <tr>
                  ...
                  <td><img src="{{ $row['testimonial_image_url'] }}" alt="{{ basename ($row['testimonial_image_url']) }}"></td>
                  @else
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        ...
                        @if(in_array('delete_testimonial', $user_permission_list))
