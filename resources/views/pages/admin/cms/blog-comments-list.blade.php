@section('blogs-post-comments-list-content')
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <h4>{!! trans('admin.comments_list') !!}</h4>
  </div>
</div>
        ...
        <table id="table_for_products_list" class="table table-bordered table-striped">
          <thead>
            <tr>
              ...
              <th>{!! trans('admin.blog_manager') !!}</th>
            ...
            @if(!empty($blog_comments))  
              ...
              <tr>
                @if(!empty($row->user_photo_url))
                  <td><img src="{{ $row->user_photo_url }}" alt="{{ basename ($row->user_photo_url) }}"></td>
                @else
