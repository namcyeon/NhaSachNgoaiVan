...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">{!! trans('admin.add_new_post_top_title') !!} &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.all_blogs') }}">{!! trans('admin.posts_list') !!}</a>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body featured-img-content">
          <div class="uploaded-featured-image">
            <div class="featured-sample-img"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
