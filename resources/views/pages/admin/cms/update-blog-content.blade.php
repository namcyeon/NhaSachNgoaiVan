@section('update-blog-post-content')
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">{!! trans('admin.update_post_page_title') !!} &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.all_blogs') }}">{!! trans('admin.posts_list') !!}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.add_blog') }}">{!! trans('admin.add_new_post_top_title') !!}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" target="_blank" href="{{ route('blog-single-page', $blog_details_by_slug['post_slug']) }}">{!! trans('admin.view') !!}</a>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body featured-img-content">
          ...
          <div class="uploaded-featured-image">
            <div class="featured-sample-img" style="display:none;"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
            <div class="featured-uploaded-image" style="display:block;"><img class="img-responsive" src="{{ $blog_details_by_slug['featured_image'] }}"><div class="remove-img-link"><button type="button" data-target="featured_image" class="btn btn-default attachtopost">{!! trans('admin.remove_image') !!}</button></div></div>
          </div>
          @else
          <div class="uploaded-featured-image">
            <div class="featured-sample-img" style="display:block;"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="seo-preview-content">
            ...
            <p class="link">{!! url('/') !!}/xem-tin/<span>{!! $blog_details_by_slug['blog_seo_url'] !!}</span></p>
            @else
            <p class="link">{!! url('/') !!}/xem-tin/<span>{!! string_slug_format( trans('admin.product_title_label') ) !!}</span></p>
            @endif
      ...
      <div class="box box-solid">
        ...
        <div class="box-body blog-categories">
          <div class="row">
            <div class="col-md-12">
              <div class="clearfix">
                <a class="btn btn-default pull-right" href="{{ route('admin.blog_categories_list') }}">{!! trans('admin.create_categories') !!}</a>
                  <div class="form-group">
