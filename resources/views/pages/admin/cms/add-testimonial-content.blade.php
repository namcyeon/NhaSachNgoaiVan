@section('add-testimonial-post-content')
  ...
  <div class="box">
    <div class="box-header">
      ...
      <div class="box-tools pull-right">
       <a class="btn btn-default btn-xs" href="{{ route('admin.testimonial_post_list_content') }}">{{ trans('admin.posts_list') }}</a>
        <button class="btn btn-primary btn-block" type="submit">{{ trans('admin.save') }}</button>
      </div>
    </div>
  </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body testimonial-content">
          <div class="uploaded-testimonial-image">
            <div class="testimonial-sample-img"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
