...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">{!! trans('admin.update_product') !!} &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.product_list') }}">{!! trans('admin.products_list') !!}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.add_product') }}">{!! trans('admin.add_new_product') !!}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" target="_blank" href="{{ route( 'details-page', $product_post_data['post_slug']) }}">{!! trans('admin.view') !!}</a>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-product-image">
            ...
            <div class="product-sample-img" style="display:none;"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
            <div class="product-uploaded-image" style="display:block;"><img class="img-responsive" src="{{ $product_post_data['_product_related_images_url']->product_image }}"><div class="remove-img-link"><button type="button" data-target="product_image" class="btn btn-default attachtopost">{!! trans('admin.remove_image') !!}</button></div></div>
            @else
            <div class="product-sample-img" style="display:block;"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
        ...
        <div class="box-body">
          <div class="uploaded-product-gallery-image">
            ...
            <div class="product-uploaded-gallery-image" style="display:block;">
              ...
              <div class="gallery-image-single-container"><img class="img-responsive" src="{{ $data->url }}"><div data-id="{{ $data->id }}" class="remove-gallery-img-link"></div></div>
              @endforeach
            </div>
            <div class="product-gallery-sample-img" style="display:none;"><img class="gallery-upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
            @else
            <div class="product-gallery-sample-img"><img class="gallery-upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-banner-image">
            ...
            <div class="banner-uploaded-image" style="display:block;"><img class="img-responsive" src="{{ $product_post_data['_product_related_images_url']->shop_banner_image }}"><div class="remove-img-link banner-img-remove"><button type="button" class="btn btn-default attachtopost">{!! trans('admin.remove_image') !!}</button></div></div>
            <div class="banner-sample-img" style="display:none;"><img class="banner-upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
            @else
            <div class="banner-sample-img"><img class="banner-upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
                          ...
                          <div class="custom-input-group">
                            ...
                            <div class="custom-input-element">
                              ...
                              <div class="variation-img-content">
                                <div class="variation-sample-img"><img class="img-responsive" src="{{ default_placeholder_img_src() }}" alt="variation-sample"></div>
                  ...
                  @if(count($variation_data)>0)
                    <table class="table table-bordered table-striped admin-data-table">
                      ...
                      <tr>
                        ...
                        <td><img src="{{ $row['_variation_post_img_url'] }}" alt="{{ basename ($row['_variation_post_img_url']) }}"></td>
                        @else 
                        <td><img src="{{ asset('resources/assets/images/no-image.png') }}" alt="no_img"></td>
                        @endif
                  ...
                  <div class="col-md-12">                    
                    ...
                    <div class="form-group">
                      ...
                      <div class="design-element-main-container">
                        @if(count($product_post_data['_product_custom_designer_data'])>0)  
                                ...
                                <div class="form-group">
                                  <div class="col-sm-6">
                                    <div class="design-img-content">
                                      ...
                                      <div class="design-img" style="display:block;"><img class="img-responsive" src="{{ $row->design_img_url }}" alt=""></div>
                                      <div class="design-sample-img" style="display:none;"><img class="img-responsive" src="{{ asset('resources/assets/images/upload.png') }}" alt="no_img"></div>  
                                      @else
                                      <div class="design-img" style="display:none;"><img class="img-responsive" alt=""></div>
                                      <div class="design-sample-img" style="display:block;"><img class="img-responsive" src="{{ asset('resources/assets/images/upload.png') }}" alt="no_img"></div>  
                                      @endif
                                      <br>
                                  ...
                                  <div class="col-sm-6">
                                    <div class="design-img-content">
                                      ...
                                      <div class="trans-design-img" style="display:block;"><img class="img-responsive" src="{{ $row->design_trans_img_url }}" alt=""></div>
                                      <div class="trans-design-sample-img" style="display:none;"><img class="img-responsive" src="{{ asset('resources/assets/images/upload.png') }}" alt="no_img"></div>  
                                      @else
                                      <div class="trans-design-img" style="display:none;"><img class="img-responsive" alt=""></div>
                                      <div class="trans-design-sample-img" style="display:block;"><img class="img-responsive" src="{{ asset('resources/assets/images/upload.png') }}" alt="no_img"></div>  
                                      @endif
                                      <br>
                                ...
                                <div class="form-group">
                                  <div class="col-sm-12">
                                    <div class="design-title-img-content">
                                      ...
                                      <div class="design-title-img" style="display:block;"><img class="img-responsive" src="{{ $row->design_title_icon }}" alt=""></div>
                                      <div class="design-title-sample-img" style="display:none;"><img class="img-responsive" src="{{ asset('resources/assets/images/upload.png') }}" alt="no_img"></div>
                                      @else
                                      <div class="design-title-img" style="display:none;"><img class="img-responsive" alt=""></div>
                                      <div class="design-title-sample-img" style="display:block;"><img class="img-responsive" src="{{ asset('resources/assets/images/upload.png') }}" alt="no_img"></div>
                                      @endif
                                      <br>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="seo-preview-content">
            ...
            <p class="link">{!! url('/') !!}/san-pham/dang-xem/<span>{!! $product_post_data['post_slug'] !!}</span></p>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <br>  
              @if(!empty($fields_name) && count($fields_name) > 0)
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                 ...
                 <div class="manufacturer-name">
                   ...
                   @if($row['brand_logo_img_url'])<div><img src="{{ url('/').$row['brand_logo_img_url'] }}" class="img-responsive"></div>@else <div><img src="{{ asset('resources/assets/images/no-image.png') }}" class="img-responsive"></div> @endif<div>{!! $row['name'] !!}</div><div>({!! $row['brand_country_name'] !!})</div>
                 </div>
                 @endforeach
                </div>
              </div>
