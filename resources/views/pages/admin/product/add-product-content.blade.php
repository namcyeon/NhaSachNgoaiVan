...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">{!! trans('admin.add_new_product') !!} &nbsp;&nbsp;&nbsp;&nbsp;</h3>
      <div class="box-tools pull-right">
        <a class="btn btn-default btn-xs" href="{{ route('admin.product_list') }}">{!! trans('admin.products_list') !!}</a>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-product-image">
            <div class="product-sample-img"><img class="upload-icon img-responsive" src="{{ asset('resources/assets/images/upload.png') }}"></div>
                          ...
                          <div class="custom-input-group">
                            ...
                            <div class="custom-input-element">
                              ...
                              <div class="variation-img-content">
                                <div class="variation-sample-img"><img class="img-responsive" src="{{ asset('resources/assets/images/upload.png') }}" alt=""></div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="seo-preview-content">
            ...
            <p class="link">{!! url('/') !!}/san-pham/dang-xem/<span>{!! string_slug_format( trans('admin.product_title_label') ) !!}</span></p>
