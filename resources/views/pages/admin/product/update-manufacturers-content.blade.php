        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <div class="manufacturers-img-content">
              ...
              <div class="manufacturers-img" {!! $manufacturers_logo_control['manufacturers_logo'] !!}><img class="img-responsive" src="{{ asset($manufacturers_update_data['brand_logo_img_url']) }}" alt=""></div>
              <br>
