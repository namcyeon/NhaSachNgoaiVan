  ...
  <div class="col-xs-12">
				<div class="clearfix">
						...
						<div class="modal fade" id="productImport" tabindex="-1" role="dialog" aria-labelledby="updater" aria-hidden="true">
                              ...
                              <div class="sample-csv-download"><a href="{{ url('/'). '/resources/assets/extra-files/products_import.csv' }}" download="">[ {!! trans('admin.sample_csv_file_label') !!} ]</a></div>
														</div>
    ...
    <div class="box">
      <div class="box-body">
        <div id="table_search_option">
          <form action="{{ route('admin.product_list') }}" method="GET"> 
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="input-group">
                  <input type="text" name="term_product" class="search-query form-control" placeholder="{!! trans('admin.product_name_to_search') !!}" value="{{ $search_value }}" />
            ...
            @if($product_all_data->count() > 0)  
              ...
              <tr>
                @if(!empty($row['_product_related_images_url']->product_image))
                  <td><img src="{{ $row['_product_related_images_url']->product_image }}" alt="{{ basename ($row['_product_related_images_url']->product_image) }}"></td>
                @else
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      ...
                      @endif
                      @if(in_array('delete_product', $user_permission_list)) 
