  ...
  <div class="modal-dialog add-cat-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p class="no-margin top-title"><b>{!! trans('admin.create_new_post_category') !!}</b></p>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default attachtopost create-cat-post">{!! trans('admin.create_category') !!}</button>
