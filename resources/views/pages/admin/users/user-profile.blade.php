  ...
  <div class="box box-solid">
    <div class="box-header">
      ...
      <div class="box-tools pull-right">
        <button class="btn btn-primary pull-right" type="submit">{{ trans('admin.save_change') }}</button>
      </div>
    </div>
  </div>
            ...
            <div class="col-sm-8 profile-picture-content">
               @if($user_profile_data->user_photo_url)
                <div class="profile-picture">
                  <div class="img-div"><img src="{{ asset('public/uploads/'.$user_profile_data->user_photo_url) }}" class="user-image" alt=""/></div><br>
