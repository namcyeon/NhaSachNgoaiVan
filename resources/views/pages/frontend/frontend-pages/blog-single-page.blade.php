@section('frontend-blog-single-page-content')
<br>
  ...
  <div class="row">
    <div class="col-md-6 col-md-push-3">
      <div class="blog-media">
        ...
        <img class="img-responsive" src="{{ $blog_details_by_slug['featured_image'] }}" alt="{{ basename($blog_details_by_slug['featured_image']) }}">
        @else
        <img class="img-responsive" src="{{ asset('resources/assets/images/no-image.png') }}" alt="media">
        @endif
      </div>
      <div class="blog-text">
        <p>
              ...
              <div class="col-md-12 blog-box extra-padding">
                <a href="{{ route('blog-single-page', $items['post_slug'])}}">
                  @if(!empty($items['blog_image']))  
                    <img class="img-responsive" src="{{ $items['blog_image'] }}"  alt="{{ basename($items['blog_image']) }}">   
                  @else
                    <img class="img-responsive" src="{{ asset('resources/assets/images/no-image.png') }}"  alt="">   
                  @endif
          ...
          <li class="comment">
            <div class="comment-container clearfix">
              <div class="user-img">
                ...
                <img alt="" src="{{ $comment->user_photo_url }}" class="avatar photo" width="60" height="60">
                @else
                <img alt="" src="{{ asset('resources/assets/images/avatar.jpg') }}" class="avatar photo" width="60" height="60">
                @endif
              </div>
