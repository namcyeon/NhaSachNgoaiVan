            ...
            <tbody>
              ...
              <tr>
                ...
                @foreach($compare_product_data as $products)
                  @if($label == 'Image')
                  <td><img src="{{ $products['_product_related_images_url']->product_image }}" alt="{{ basename($products['_product_related_images_url']->product_image) }}"></td>
                  @endif
                  ...
                  @if($label == 'Price')
                  <td>{!! get_currency_symbol_by_code( get_frontend_selected_currency() ).$products['_product_price'] !!}</td>
                  @endif
