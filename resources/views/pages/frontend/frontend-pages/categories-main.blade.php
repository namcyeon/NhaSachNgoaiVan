          ...
          <div class="advertisement-right">
            <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                ...
                <div class="item">
                  <div class="text-center">
                    <a href=""><img src="{{ asset('resources/assets/images/add-sample/girl-in-sunglass.jpg') }}" alt="" class="img-responsive" /></a>
                  </div>
                </div> 
                <div class="item">
                  <div class="text-center">
                    <a href=""><img src="{{ asset('resources/assets/images/add-sample/T-shirt.jpg') }}" alt="" class="img-responsive" /></a>
                  </div>
                </div>
              </div>
