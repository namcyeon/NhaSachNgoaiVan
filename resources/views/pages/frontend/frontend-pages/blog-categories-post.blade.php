@section('frontend-blogs-cat-post-content')
<br>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="blog-media">
                  ...
                  <img class="img-responsive" src="{{ get_blog_postmeta_data($row->id, 'featured_image') }}" alt="{{ basename(get_blog_postmeta_data($row->id, 'featured_image')) }}">
                  @else
