...
shopist.pageLoad =
{
  elementLoad:function()
  {
    ...
    if($('#inputSalePriceStartDate').length>0 || $('#inputSalePriceEndDate').length>0 || $('#inputVariationSalePriceStartDate').length>0 || $('#inputVariationSalePriceEndDate').length>0 || $('#filter_start_date').length>0 || $('#filter_end_date').length>0 || $('#inputUsageStartDate').length>0 || $('#inputUsageEndDate').length>0 || $('#download_expiry').length>0)
    {
      $('#inputSalePriceStartDate,#inputSalePriceEndDate,#inputVariationSalePriceStartDate,#inputVariationSalePriceEndDate,#filter_start_date,#filter_end_date,#inputUsageStartDate,#inputUsageEndDate, #download_expiry').datepicker({ format: 'yyyy-mm-dd'});
    }
    
    reportProductTitleDataTable = $('#table_for_report_product_title').dataTable();
    
    if($('.select2').length>0 || $('#change_order_status').length>0 || $('#change_conditions_type').length>0 ||$('#user_role_usage_restriction').length>0 )
    {
      $(".select2, #change_order_status, #change_conditions_type, #user_role_usage_restriction").select2();
    }
...
//    if($('.export-csv-file').length>0){
//      $('.export-csv-file').on('click', function(){
//        $.ajax({
//          url: $('#hf_base_url').val() + '/ajax/export_products',
//          type: 'POST',
//          cache: false,
//          dataType: 'json',
//          headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
...
shopist.event = 
{
  ...
  createCatPost:function()
  {
    if($('.create-cat-post').length>0)
    {
      $('.create-cat-post').click(function()
      {               
        if($('#inputCatName').val() == '' || $('#inputCatName').val() == null || $('#inputCatName').val().length == 0)
        {
          $('#inputCatName').css({'border':'2px solid #dc3232'});
        ...
        if(($('#inputCatName').val() != '' && $('#inputCatSlug').val() != '' && $('#inputCatName').val().length != 0 && $('#inputCatSlug').val().length != 0 ) || ($('#inputCatName').val() != null && $('#inputCatSlug').val() != null && $('#inputCatName').val().length != 0 && $('#inputCatSlug').val().length != 0))
        {
          shopist.ajaxRequest.add_new_cat_post();
        }
      });
    }
  },
  ...
  {
    if($('.comments-status-change').length>0){
      $('.comments-status-change').on("click", function(e){
        e.preventDefault();
        var item_id = null;
        var status  = null;
        var target  = null;
          ...
          if($('.design-element-main-container').length>0)
          {
            ...
            if($('#hf_custom_designer_data').length>0)
            {
              if($('#hf_custom_designer_data').val() != '' || $('#hf_custom_designer_data').val().length>0)
              {
                ...
                data_arry.push({id:count_id, title_label:title_label, design_img_url:$('#hf_base_url').val() + '/images/no-image.png', design_trans_img_url:'', design_title_icon:$('#hf_base_url').val() + '/images/no-image.png'});
              }
              else
              {
                data_arry.push({id:count_id, title_label:title_label, design_img_url:$('#hf_base_url').val()+ '/images/no-image.png', design_trans_img_url:'', design_title_icon:$('#hf_base_url').val() + '/images/no-image.png'});
  ...
  manageFrontendTemplates:function()
  {
    if($('.activate-templates').length>0)
    {
      $('.activate-templates').on('click', function(e)
      {
        ...
        obj.parents('.manage-template').after('<div class="template_activate_loader"><img src="'+ $('#hf_base_url').val() +'/resources/assets/images/ajax-loader_001.gif" alt="ajax-loader"></div>');
...
shopist.ajaxRequest = 
{
  ...
  add_new_cat_post:function(){
    ...
    $.ajax({
          url: $('#hf_base_url').val() + '/ajax/add-cat-post',
          type: 'POST',
          cache: false,
          dataType: 'json',
          data: {data:dataObj},
  ...
  add_new_variation:function()
  {
    ...
    if($('.variation-img img').attr('src')){
      img_url = $('.variation-img img').attr('src');
    }
          ...
          success: function(data){
            if(data.success == true){
              if( track == 'cat_list' ){
                ...
                if(data.img_url)
                {
                  $('.cat-img img').attr('src', data.img_url);
                ...
                {
                  $('.variation-img img').attr('src', parseData._variation_post_img_url);
...
shopist.normalFunction=
{
  ...
  add_design_element_html:function(count, val)
  {
    ...
    str += '<div class="form-group"><div class="col-sm-6"><div class="design-img-content"><div class="design-sample-img"><img class="img-responsive" src="'+ baseUrl +'/resources/assets/images/upload.png" alt="no_img"></div><div class="design-img"><img class="img-responsive" src="" alt=""></div><br><div class="design-img-upload-btn"><div><button type="button" data-name="only_design_img" class="btn btn-default attachtopost upload-design-img">'+  adminLocalizationString.upload_design_image +'</button></div><div><button type="button" data-name="design_img" data-id="solid-'+ count +'" class="btn btn-default attachtopost remove-design-img">'+ adminLocalizationString.remove_image +'</button></div></div></div></div><div class="col-sm-6"><div class="design-img-content"><div class="trans-design-sample-img"><img class="img-responsive" src="'+ baseUrl +'/resources/assets/images/upload.png" alt="no_img"></div><div class="trans-design-img"><img class="img-responsive" src="" alt=""></div><br><div class="trans-design-img-upload-btn"><div><button type="button" data-name="only_trans_design_img" class="btn btn-default attachtopost upload-design-img">'+ adminLocalizationString.upload_design_transparent_image +'</button></div><div><button type="button" data-name="trans_design_img" data-id="trans-'+ count +'" class="btn btn-default attachtopost remove-design-img">'+ adminLocalizationString.remove_image +'</button></div></div></div></div></div><hr>';
    str += '<div class="form-group"><div class="col-sm-12"><div class="design-title-img-content"><div class="design-title-sample-img"><img class="img-responsive" src="'+ baseUrl +'/resources/assets/images/upload.png" alt="no_img"></div><div class="design-title-img"><img class="img-responsive" src="" alt=""></div><br><div class="design-title-img-upload-btn"><div><button type="button" data-name="only_design_title_img" class="btn btn-default attachtopost upload-design-title-img">'+ adminLocalizationString.upload_design_title_icon +'</button></div><div><button type="button" data-name="design_title_img" data-id="'+ count +'" class="btn btn-default attachtopost remove-design-title-img">'+ adminLocalizationString.remove_image +'</button></div></div></div></div></div></div></div></div></div>';
      ...
      var parseJson = JSON.parse($('#hf_custom_designer_data').val());
       ...
       if(source == 'design_img')
       {
         for(var i = 0; i<parseJson.length; i++)
         {
           ...
           {
             parseJson[i].design_img_url = '/resources/assets/images/upload.png';
             break;
           }
         }
       }
       ...
       else if(source == 'design_title_img')
       {
         for(var j = 0; j<parseJson.length; j++)
         {
           if(parseJson[j].id == id)
           {
             parseJson[j].design_title_icon = '/resources/assets/images/upload.png';
             break;
           }
         }
       }
          ...
          this.on("success", function(file, response) 
          {
            ...
            {  
              ...
              if(name == 'product_image')
              {
                ...
                {
                  shopist.normalFunction.createJsonDataForAllProductImage('product_image', base_url + '/public/uploads/' + response.name);
                }
              }
                ...
                if($('#image_url').length>0){
                  $('#image_url').val( base_url + '/public/uploads/' + response.name );
		}
              }
                ...
                if(parseResponse.length>0)
                {
                  for(var count = 0; count < parseResponse.length; count ++)
                  {
                    ...
                    if($('.product-uploaded-gallery-image').find('.' + addExtraId).length == 0)
                    {
                      ...
                      if($('#hf_uploaded_all_images').length>0)
                      {
                        shopist.normalFunction.createJsonDataForAllProductImage('product_gallery_images', {id:id, url:base_url + '/public/uploads/' + parseResponse[count]});
                      }
                    }
                  }
                }
              ...
              else if(name == 'shop_banner_image')
              {
                ...
                if($('#hf_uploaded_all_images').length>0)
                {
                  shopist.normalFunction.createJsonDataForAllProductImage('shop_banner_image', base_url + '/public/uploads/' + response.name);
                }
              }
              ...
              else if(name == 'designer_img')
              {
                if(clickTrackForDesignerUploader && clickTrackForDesignerUploader.split(',')[0] == 'only_design_img')
                {
                  ...
                  shopist.normalFunction.createJsonDataForAllDesignerImage('only_design_img', clickTrackForDesignerUploader.split(',')[1], base_url + '/public/uploads/' + response.name);
                }
                else if(clickTrackForDesignerUploader && clickTrackForDesignerUploader.split(',')[0] == 'only_trans_design_img')
                {
                  ...
                  shopist.normalFunction.createJsonDataForAllDesignerImage('only_trans_design_img', clickTrackForDesignerUploader.split(',')[1], base_url + '/public/uploads/' + response.name);
                }
                else if(clickTrackForDesignerUploader && clickTrackForDesignerUploader.split(',')[0] == 'only_design_title_img')
                {
                  ...
                  shopist.normalFunction.createJsonDataForAllDesignerImage('only_design_title_img', clickTrackForDesignerUploader.split(',')[1], base_url + '/public/uploads/' + response.name);
                }
              ...
              else if(name == 'profile_picture')
              {
                ...
                $('#hf_profile_picture').val( response.name );
              }
              else if(name == 'site_picture')
              {
                ...
                $('#hf_site_picture').val( response.name );
              }
                ...
                if(parseResponse.length>0)
                {
                  for(var count = 0; count < parseResponse.length; count ++)
                  {
                    ...
                    if($('.uploaded-header-slider-images .uploaded-slider-images').find('.' + addExtraId).length == 0)
                    {
                      ...
                      {
                        shopist.normalFunction.createJsonDataForAllFrontendImage('header_slider_images', {id:id, url:base_url + '/public/uploads/' + parseResponse[count]});
                      }
