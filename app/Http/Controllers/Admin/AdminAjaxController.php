...
use shopist\Http\Controllers\PostController;
...
class AdminAjaxController extends Controller
{
  ...
  public function saveCategoriesDetails(){
    ...
    if(Request::isMethod('post') && Request::ajax()){
      if(Session::token() == Request::header('X-CSRF-TOKEN')){
        if((isset($input['data']['name'])&& $input['data']['name']) && (isset($input['data']['slug']) && $input['data']['slug'])){
					...
					$termObj					=			new ProductTerm;
					$termExtraObj			=			new ProductTermExtra;
          $cat_slug					=			'';
												
          $check_slug  = ProductTerm::where(['slug' => string_slug_format( $input['data']['slug'] )])->orWhere('slug', 'like', '%' . string_slug_format( $input['data']['slug'] ) . '%')->get()->count();
          ...
          elseif ($input['data']['click_source'] == 'for_update'){
            ...
            if( ProductTerm::where('term_id', $input['data']['id'])->update($data)){
              $description = array(
                              'key_value'    =>  $input['data']['description']
              );
              ...
              ProductTermExtra::where(['term_id' => $input['data']['id'], 'key_name' => '_category_description'])->update($description);
              ProductTermExtra::where(['term_id' => $input['data']['id'], 'key_name' => '_category_img_url'])->update($img_url);
    ...
    public function saveCategoriesPostDetails(){
    $input = Request::all();
  ...
  public function saveTagsDetails(){
    ...
    if(Request::isMethod('post') && Request::ajax() && Session::token() == Request::header('X-CSRF-TOKEN')){
      if(isset($input['data']['name'])&& $input['data']['name']){
        ...
        $check_slug  =  ProductTerm::where(['slug' => string_slug_format( $input['data']['name'] )])->orWhere('slug', 'like', '%' . string_slug_format( $input['data']['name'] ) . '%')->get()->count();
        ...
        elseif ($input['data']['click_source'] == 'for_update'){
          ...
          if( ProductTerm::where('term_id', $input['data']['id'])->update($data)){
            ...
            ProductTermExtra::where(['term_id' => $input['data']['id'], 'key_name' => '_tag_description'])->update($description);
            return response()->json(array('success' => TRUE));
          }
        }
      }
  ...
  public function saveAttributesDetails(){
    ...
    if(Request::isMethod('post') && Request::ajax() && Session::token() == Request::header('X-CSRF-TOKEN')){
      if((isset($input['data']['attrName'])&& $input['data']['attrName']) && (isset($input['data']['attrVal'])&& $input['data']['attrVal'])){
        ...
        $check_slug  =  ProductTerm::where(['slug' => string_slug_format( $input['data']['attrName'] )])->orWhere('slug', 'like', '%' . string_slug_format( $input['data']['attrName'] ) . '%')->get()->count();
        ...
        elseif ($input['data']['click_source'] == 'for_update'){
          ...
          if( ProductTerm::where('term_id', $input['data']['id'])->update($data)){
            ...
            ProductTermExtra::where(['term_id' => $input['data']['id'], 'key_name' => '_product_attr_values'])->update($attrVal);
            return response()->json(array('success' => TRUE));
          }
        }
      }
  ...
  public function saveColorDetails(){
    ...
    if(Request::isMethod('post') && Request::ajax() && Session::token() == Request::header('X-CSRF-TOKEN')){
      if((isset($input['data']['colorName'])&& $input['data']['colorName'])){
        ...
        $check_slug  =  ProductTerm::where(['slug' => string_slug_format( $input['data']['colorName'] )])->orWhere('slug', 'like', '%' . string_slug_format( $input['data']['colorName'] ) . '%')->get()->count();
        ...
        elseif ($input['data']['click_source'] == 'for_update'){
          ...
          if( ProductTerm::where('term_id', $input['data']['id'])->update($data)){
            ...
            ProductTermExtra::where(['term_id' => $input['data']['id'], 'key_name' => '_product_color_code'])->update($colorCode);
            return response()->json(array('success' => TRUE));
          }
        }
      }
  ...
  public function saveSizeDetails(){
    ...
    if(Request::isMethod('post') && Request::ajax() && Session::token() == Request::header('X-CSRF-TOKEN')){
      if((isset($input['data']['sizeName'])&& $input['data']['sizeName'])){
        ...
        $check_slug  =  ProductTerm::where(['slug' => string_slug_format( $input['data']['sizeName'] )])->orWhere('slug', 'like', '%' . string_slug_format( $input['data']['sizeName'] ) . '%')->get()->count();
  ...
  public function saveProductsVariations(){
    ...
    if(Request::isMethod('post') && Request::ajax() && Session::token() == Request::header('X-CSRF-TOKEN')){
      if((isset($input['data']['variation_sku'])&& $input['data']['variation_sku'])){
        $skuCheck  =  ProductExtra:: where(['key_name' => '_variation_post_sku', 'key_value' => $input['data']['variation_sku']])->first();
        ...
        if( ( count($skuCheck) > 0 &&  $skuCheck->post_id == $input['data']['variation_id'] ) ||  (count($skuCheck) == 0) ){
          ...
          $post_slug = '';
          $check_slug  = Product::where(['post_slug' => string_slug_format( 'New product variation' )])->orWhere('post_slug', 'like', '%' . string_slug_format( 'New product variation' ) . '%')->get()->count();
          ...
          elseif(isset($input['data']['post_type'])&& $input['data']['post_type'] == 'update_post'){
            ...
            if( Product::where('id', $input['data']['variation_id'])->update($data)){
              $data_url = array(
                                'key_value'    =>  $input['data']['url']
              );
              $data_sku = array(
              ...
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_img_url'])->update($data_url);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_sku'])->update($data_sku);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_regular_price'])->update($data_regular_price);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_sale_price'])->update($data_sale_price);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_price'])->update($data_price);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_sale_price_start_date'])->update($data_start_date);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_sale_price_end_date'])->update($data_end_date);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_manage_stock'])->update($data_manage_stock);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_manage_stock_qty'])->update($data_stock_qty);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_back_to_order'])->update($data_back_order);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_stock_availability'])->update($data_stock_status);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_enable_tax'])->update($data_tax);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_variation_post_data'])->update($data_variation_json);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_is_role_based_pricing_enable'])->update($data_is_role_based_enable);
							ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_role_based_pricing'])->update($data_role_based_pricing);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_downloadable_product_data'])->update($data_downloadable_product_data);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_downloadable_limit'])->update($downloadable_limit);
              ProductExtra::where(['post_id' => $input['data']['variation_id'], 'key_name' => '_download_expiry'])->update($downloadable_expiry);
  ...
  public function selectedItemDeleteById(){
    ...
    if(Request::isMethod('post') && Request::ajax() && Session::token() == Request::header('X-CSRF-TOKEN')){
      if($input['data']['id'] && $input['data']['track']){
        if($input['data']['track'] == 'cat_list' || $input['data']['track'] == 'tag_list' || $input['data']['track'] == 'attr_list' || $input['data']['track'] == 'color_list' || $input['data']['track'] == 'size_list' || $input['data']['track'] == 'manufacturers_list'){
          if(ProductTerm::where('term_id', $input['data']['id'])->delete()){
            ProductTermExtra::where('term_id', $input['data']['id'])->delete();
        ...
        elseif($input['data']['track'] == 'art_list'){
          if(Product::where('id', $input['data']['id'])->delete()){
            ProductExtra::where('post_id', $input['data']['id'])->delete();
        ...
        elseif($input['data']['track'] == 'variation_data_list'){
          ...
          $parent_id = Product::where('id', $input['data']['id'])->first();
          
          if(Product::where('id', $input['data']['id'])->delete()){
            if(ProductExtra::where('post_id', $input['data']['id'])->delete()){
        ...
        elseif($input['data']['track'] == 'attr_data_list' && $input['data']['item_id']){
          $postmeta_count   =  ProductExtra::where(['post_id' => $input['data']['id'], 'key_name' => '_attribute_post_data'])->count();
          $postmeta         =  ProductExtra::where(['post_id' => $input['data']['id'], 'key_name' => '_attribute_post_data'])->first();
          ...
          if($postmeta_count>0){
            ...
            if(count($get_attr_data)>0){
              ...
              ProductExtra::where(['post_id' => $input['data']['id'], 'key_name' => '_attribute_post_data'])->update($data_attr);
    ...
    public function selectedProductDeleteById(){
    $input = Request::all();
    ...
    if(Request::isMethod('post') && Request::ajax() && Session::token() == Request::header('X-CSRF-TOKEN')){
      if($input['data']['id'] && $input['data']['track']){
        if($input['data']['track'] == 'cat_list' || $input['data']['track'] == 'tag_list' || $input['data']['track'] == 'attr_list' || $input['data']['track'] == 'color_list' || $input['data']['track'] == 'size_list' || $input['data']['track'] == 'manufacturers_list'){
          if(ProductTerm::where('term_id', $input['data']['id'])->delete()){
            ProductExtra::where('term_id', $input['data']['id'])->delete();
            return response()->json(array('delete' => true));
          }
        }
        elseif($input['data']['track'] == 'art_cat_list'){
  ...
  */
  ...
  public function addAttributeByProductId(){
    ...
    if(Request::isMethod('post') && Request::ajax()){
      if(Session::token() == Request::header('X-CSRF-TOKEN')){
        $postmeta_count   =  ProductExtra::where(['post_id' => $input['id'], 'key_name' => '_attribute_post_data'])->count();
        $postmeta         =  ProductExtra::where(['post_id' => $input['id'], 'key_name' => '_attribute_post_data'])->first();
        $new_ary = array();
        ...
        if($input['action'] == 'save'){
          if($postmeta_count>0){
            ...
            ProductExtra::where(['post_id' => $input['id'], 'key_name' => '_attribute_post_data'])->update($data_attr);
          }
          else{
  ...
  public function getAttributeListWithHTML( $post_id ){
    $postmeta_count  =  ProductExtra::where(['post_id' => $post_id, 'key_name' => '_attribute_post_data'])->count();
    $str = '';
    
    if($postmeta_count>0){
      $postmeta  =  ProductExtra::where(['post_id' => $post_id, 'key_name' => '_attribute_post_data'])->first();
  ...
  public function getAvailableAttributesWithHtml(){
    if(Request::isMethod('post') && Request::ajax()){
      if(Session::token() == Request::header('X-CSRF-TOKEN')){
        ...
        $get_attr_by_products  =   ProductExtra::where(['post_id' => $input['post_id'], 'key_name' => '_attribute_post_data'])->get();
