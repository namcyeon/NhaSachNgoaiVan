...
class AdminDashboardController extends Controller
{
   ...
   */
    ...
    $totalProducts  =  0;
	  $getProducts    =  Product::where(['post_type' => 'product'])->get()->toArray();
   ...
   */
	public function todayOrders(){
		$todayOrders  =  0;
		$getTodayOrders  =  Product::whereDate('created_at', '=', $this->carbonObject->today()->toDateString())->where('post_type', 'shop_order')->get()->toArray();
   ...
   */
	public function totalOrders(){
		$totalOrders  =  0;
		$getOrdersData  =  Product::where('post_type', 'shop_order')->get()->toArray();
   ...
   */
    ...
    $latest_orders     =   array();
		$last2DaysOrders   =   Product::whereBetween('created_at', array($this->carbonObject->yesterday()->toDateString(), $this->carbonObject->today()->toDateString().' 23:59:59'))->where('post_type', 'shop_order')->orderBy('created_at', 'DESC')->get()->toArray();
   ...
   */
    ...
    $latest_products  =   array();
		$getProducts      =   Product::whereBetween('created_at', array($this->carbonObject->yesterday()->toDateString(), $this->carbonObject->today()->toDateString().' 23:59:59'))->where(['post_type' => 'product'])->orderBy('created_at', 'DESC')->get()->toArray();
    ...
    if(count($getProducts) > 0){
      foreach($getProducts as $rows){
          ...
          $product_data['price'] = get_current_currency_symbol().ProductExtra::where(['post_id' => $rows['id'], 'key_name' => '_product_price'])->first()->key_value;
			  }
